...
const ProductCard = ({ p }) => {
  ...
  return (
    <div className="max-w-sm relative bg-[#1A1A1A] rounded-lg 
    shaodw dark:bg-gray-800 dark:border-gray-700">
      <section className="relative">
        <Link to={`/product/${p._id}`}>
        <span className="absolute bottom-3 right-3 bg-pink-100
         text-pink-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-pink-900 dark:text-pink-300">
            {p?.brand}
         </span>
         <img 
      ...
      <div className="p-5">
        <div className="flex justify-between">
            <h5 className="mb-2 text-base text-white dark:text-white">
                {p?.name}
            </h5>
