            ...
            <div className="p-5 w-[15rem]">
                {categories?.map((c) => (
                    ...
                    <div className="flex items-center mr-4">
                        ...
                        className="w-4 h-4 text-pink-600 bg-gray-100 border-gray-300 rounded focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 
                ...
                {uniqueBrands?.map((brand) => (
                    <>
                      <div className="flex items-center mr-4 mb-5">
                        ...
                        className="w-4 h-4 text-pink-400 bg-gray-100 border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800
                         focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                        />
